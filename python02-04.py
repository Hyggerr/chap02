...
t5 = 1,
t6 = ('a', 'b', ('ab', 'cd'))
# 값이 1개만 있어도 끝에 , 를 붙이는 이유가 괄호가 없는 형태로 튜플로 데이터를 입력할 수 있기 때문에 
# 단순 숫자형 변수를 입력하는 것과 튜플을 입력하는 것을 구분하기 위함
...
print("튜플 슬라이싱 하기 : {0}".format(t1[:3]))
print()
t2 = (3, 4)
